...
CHANNEL_IDS = {
    ...
    'egwhiteaudio': {'id': 'UCPS3A-60tKmKTCKWZMT9upA', 'query_format': '{year} Q{quarter} Lesson {lesson_number} – EGW Notes – {lesson_title}', 'first_result': True, 'confirm_download': False},
}
